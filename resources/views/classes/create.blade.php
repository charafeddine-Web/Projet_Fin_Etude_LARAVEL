...
<div class="border-b border-gray-900/10 pb-12">
    ...
    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-green-50 dark:bg-gray-500 dark:text-red-800" role="alert">
    ...
    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <form action="{{ route('admin/classes/store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="sm:col-span-4">
                ...
                <div class="mt-2">
                    <input type="text" required name="Nom_Classe" id="Nom_Classe"
            ...
            <div class="sm:col-span-4">
                ...
                <div class="mt-2">
                    <input id="Annee_Formation" required name="Annee_Formation" type="integer"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div class="sm:col-span-4">
                ...
                <div class="mt-2">
                    <input id="Mode_Formation" required name="Mode_Formation" type="text"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div class="sm:col-span-4">
