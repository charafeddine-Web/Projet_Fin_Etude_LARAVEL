...
//  save and  exporte Emploi du Temps
    $(document).ready(function() {
        $('#saveBtn').click(function() {
            ...
            var annee_formation = currentYear + previousYear;
        ...
        $('#exportBtn').click(function() {
            window.location.href = '{{ route("pages.export") }}';
        });
    });
...
document.addEventListener('DOMContentLoaded', function () {
    document.getElementById('filiere').addEventListener('change', function () {
        var selectedFiliere = this.options[this.selectedIndex].text;
        document.getElementById('selectedFiliere').innerHTML = 'Filiére : <span class="font-bold">' + selectedFiliere + '</span>';
    });

    document.getElementById('classe').addEventListener('change', function () {
        var selectedClasse = this.options[this.selectedIndex].text;
        document.getElementById('selectedClasse').innerHTML = 'Groupe : <span class="font-bold">' + selectedClasse + '</span>';
    });
});
...
function addSelectedValues(index) {
    ...
    var buttonText = '';
    if (moduleValue !== '') {
        buttonText += moduleValue + ' <hr class="w-full border-t-2 border-gray-500 font-semibold"> ';
    }
    if (profValue !== '') {
        buttonText += profValue+ ' <hr class="w-full border-t-2 border-gray-500 font-semibold"> ';
    }
    if (salleValue !== '') {
        buttonText += salleValue + ' <hr class="w-full border-t-2 border-gray-500 font-semibold"> ';
    }
    if (modeValue !== '') {
