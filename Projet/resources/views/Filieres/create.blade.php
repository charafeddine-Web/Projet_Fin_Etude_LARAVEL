...
@section('contents')
<h1 class="font-bold text-2xl ml-3">Add Filiere :</h1>
<hr />
@if (Session::has('errorfiliere'))
<div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-green-100 dark:bg-gray-500 dark:text-red-800" role="alert">
    ...
    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <form action="{{ route('admin/filieres/store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="sm:col-span-4">
                ...
                <div class="mt-2">
                    <input type="text" required name="code_filiere" id="code_filiere"
            ...
            <div class="sm:col-span-4">
                ...
                <div class="mt-2">
                    <input type="text" required name="Nom_Filiere" id="Nom_Filiere"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div class="sm:col-span-4">
                ...
                <div class="mt-2">
                    <input type="text" required name="annee" id="annee"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            <button
                ...
                <span class=" text-lime-400 pr-1 flex w-full justify-center ">Save Filiere</span>
            </button>
        </form>
    </div>
</div>
