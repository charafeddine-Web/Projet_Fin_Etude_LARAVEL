...
@section('title', 'Home Filieres')

@section('contents')
<div class=" ">
    <h1 class="font-bold text-2xl ml-3">Home Filieres</h1>
    <hr />

    <div class="flex items-cente flex-wrap justify-center   space-x-4  w-full ">

        <form class="px-4 w-full max-w-[230px] " action="{{ route('Searchfiliere') }}" method="GET">

            <div class="relative">
                <input type="text" name="keyword" id="keyword" value="{{ request('keyword') }}"
                    class="w-full max-w-[160px] text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 outline-none focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="" id="">
        ...
        <form action="{{ route('admin/filieres/importExcel') }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    <table
        ...
        <thead class="text-xs min-w-full text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th scope="col" class="px-6 py-3">Code Filiere</th>
                <th scope="col" class="px-6 py-3">Nom Filiere</th>
        ...
        <tbody class="min-w-full overflow-x-auto py-4 lg:overflow-x-hidden">
            ...
            <tr class=" border-b bg-[#f8f4f3]  dark:border-gray-700 hover:bg-gray-600 dark:hover:bg-gray-300">
                ...
                <td class="px-6 py-4 whitespace-nowrap w-full md:w-auto">
                    <div class="h-14 pt-5 flex justify-center md:justify-start">
                        <a href="{{ route('admin/filieres/show', $rs->id) }}" class="text-blue-800">
                        ...
                        <a href="{{ route('admin/filieres/edit', $rs->id)}}" class="text-green-800 pl-2">
                        ...
                        <form action="{{ route('admin/filieres/destroy', $rs->id) }}" method="POST"
                            ...
                            <button>
                                <svg class="w-6 h-6 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 6v14">
                                    </path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 6v14">
                                    </path>
                                </svg>
                            </button>
                        </form>
            ...
            @else
            <tr>
                <td class="text-center" colspan="5">Filiere not found</td>
            </tr>
            @endif
        </tbody>
    </table>
