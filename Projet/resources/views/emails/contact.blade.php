...
<div class=" mt-40 card   bg-gray-500 transition duration-1000 ease-in-out rounded-tr-3xl rounded-bl-3xl    ">
    ...
    <p class="info font-normal text-white text-center block text-sm my-4 mx-2">  En tant que développeur Full-Stack, j'ai des compétences dans les technologies front-end et back-end, me permettant de concevoir,
            ...
            <form action="{{ route('contact.send') }}" method="post">
               @csrf
                ...
                <div class="flex items-center justify-center w-full">
                    <button class="mt-9 font-semibold leading-none text-white py-4 px-10 bg-green-700 rounded hover:bg-green-500 focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 focus:outline-none">
                        Send message
                    </button>
                </div>
            </form>
