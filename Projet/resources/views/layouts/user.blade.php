...
<body class="container   bg-cover bg-center   " style="background-image: url('/wave-haikei.svg') ">
    ...
    <div class="">
        <nav class="navbar">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 rounded-2xl  backdrop bg-black bg-opacity-60">
                <div class="flex items-center justify-between h-16">
                    <div class="flex-shrink-0 text-white  ">
                        <a href="{{ url('/') }}">
                            <h2 class="font-bold text-2xl">OF<span
                                    class="bg-[#ffffff] text-black px-2 rounded-md">PPT</span></h2>
                        </a>
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            @auth
                            <button
                                class="bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-black">
                            ...
                            <div x-data="{show: false}" x-on:click.away="show = false" class="ml-3 relative">
                                <div>
                                    <button x-on:click="show=!show" type="button"
                                        class="max-w-xs  rounded-full flex items-center text-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-black"
                                        id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        <span class="sr-only">Open user menu</span>
                                        <img class="h-8 w-8 rounded-full" src="/admin.png" alt="">
                                        <div class="text-base font-medium leading-none text-white">
                                            {{ auth()->user()->name }}</div></br>
                                    </button>
                                </div>
                                <div x-show="show"
                                    ...
                                    tabindex="-1">
                                    <a href="{{ route('userprofile') }}" class="block px-4 py-2 text-sm text-gray-100"
                                        role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>

                                    <a href="{{ route('logout') }}" class="block px-4 py-2 text-sm text-gray-100"
                                        role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</a>
                                </div>
                            </div>
                            @else
                            <a href="{{ route('login') }}"
                                class="inline-flex items-center px-4 py-2 ml-4 text-green-500 font-bold border border-blue-500 rounded-lg hover:bg-green-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Log
                                in<span aria-hidden="true">&rarr;</span></a>

                            @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="inline-flex items-center px-4 py-2 ml-4 text-green-500 font-bold border border-blue-500 rounded-lg  hover:bg-green-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Register<span
                    ...
                    <div class="-mr-2 flex md:hidden">
                        ...
                        <button type="button"
                            class="bg-gray-800 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-black hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-black"
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    <a href="{{ url('/') }}"
                        class="   text-white  hover:bg-green-400 hover:text-white  block px-3 py-2 rounded-md text-base font-medium">Home</a>
                    <a href="{{ route('emploi') }}"
                        class="text-gray-300  hover:bg-green-400 hover:text-white   block px-3 py-2 rounded-md text-base font-medium">Emploi</a>
                    <a href="{{ route('About') }}"
                        class="text-gray-300   hover:bg-green-400 hover:text-white  block px-3 py-2 rounded-md text-base font-medium">About</a>
                    <a href="{{ route('contact') }}"
                        class="text-gray-300  hover:bg-green-400 hover:text-white   block px-3 py-2 rounded-md text-base font-medium">Contact</a>
                ...
                <div class="pt-4 pb-3 border-t border-gray-700">
                    ...
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">
                                {{isset( auth()->user()->name )?"Admin":"" }}</div>
                            <div class="text-sm font-medium leading-none text-gray-400">
                                {{isset(auth()->user()->email)?"":""  }}</div>
                        </div>
                        <button
                            class="ml-auto bg-gray-800 flex-shrink-0 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-black">
                            <span class="sr-only">View notifications</span>
                            <!-- Heroicon name: outline/bell -->
                            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" aria-hidden="true">
                ...
                @else
                <a href="{{ route('login') }}"
                    class="inline-flex items-center px-4 py-2 ml-4 text-green-500 hover:bg-green-400 hover:text-white font-bold border border-blue-500 rounded-lg  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Log
                    in<span aria-hidden="true">&rarr;</span></a>

                @if (Route::has('register'))
                <a href="{{ route('register') }}"
                    class="inline-flex items-center px-4 py-2 ml-4 text-green-500 hover:bg-green-400 hover:text-white font-bold border border-blue-500 rounded-lg  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Register<span
                        aria-hidden="true">&rarr;</span></a>
                @endif
                @endauth
                @endif
        ...
        <!-- component Footer -->
       <footer>
            <div class="flex flex-col mx-3 justify-center rounded-lg">
                <div class="w-full draggable">
                    <div class="container flex flex-col mx-auto">
                        <div class="flex flex-col items-center w-full my-20">
                            <h1 class=" dark:text-white mb-10 text-3xl font-extrabold"> OF<span
                                    class="bg-[#2bad3f] text-white px-2 rounded-md">PPT</span></h1>
                            ...
                            <div class="flex flex-col items-center gap-6 mb-8">
                                ...
                                <div class="flex items-center gap-8">
                                    <a href="https://github.com/charafeddine-Web"
                                        class="text-grey-700 text-white hover:opacity-10">
                            ...
                            <div class="flex items-center">
                                <p class="text-base font-normal leading-7 text-center text-white">2024 ISTA Taza. All
                                    rights reserved--Version:{{env('APP_VERSION')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
